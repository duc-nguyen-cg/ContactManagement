...
public class InputChecker {
    private static final String INPUT_ERROR_MESSAGE = "Sai định dạng dữ liệu, nhập lại: ";
        ...
        do {
            try {
                ...
                if (result < min | result > max){
                    System.err.println(INPUT_ERROR_MESSAGE + "số nguyên từ "+min +" đến "+ max);
                }
    ...
    public static double inputDoubleInBounds(double min, double max){
        ...
        do {
            try {
                ...
                if (result < min | result > max){
                    System.err.println(INPUT_ERROR_MESSAGE + "số thực từ "+min +" đến "+ max);
                }
            } catch (InputMismatchException e){
                System.err.println(INPUT_ERROR_MESSAGE + "số thực từ "+min +" đến "+ max);
            }
    ...
    public static String inputString(int length){
        ...
        do {
            ...
            if (str.length() > length){
                System.err.println(INPUT_ERROR_MESSAGE + "Chuỗi nhập vào dài không quá "+length+" kí tự");
            }
